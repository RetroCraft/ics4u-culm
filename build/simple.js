...
yargs
    .command("file [filename]", "Simplify a file", (yargs) => {
    ...
    readFile(argv.filename, "utf8", (err, data) => {
        ...
        writeFile(`${argv.filename.substring(0, argv.filename.length - 3)}.smpl.js`, out, "utf8", err => err && console.error("Unable to write file: " + err));
    });
})
    .command("snip [code]", "Simplify a code snippet", (yargs) => {
